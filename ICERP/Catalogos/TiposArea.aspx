...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="box box-danger">
        <div class="box-header with-border">
            <h3 class="box-title">Registro de Tipos de Area</h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
            <div class="col-sm-3">
                <div class="form-group">
                    <label for="nombre">Tipo de Area</label>
                    <input type="text" class="form-control" id="nombre" placeholder="Tipo de Area">
                </div>
                <div class="checkbox">
                    <label>
    ...
    <div class="box">
        <div class="box-header">
            <h3 class="box-title">Tipos de Areas</h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
